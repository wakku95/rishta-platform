...
class UpdateAssistedListingRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'gender' => ['sometimes', 'required', 'string', \Illuminate\Validation\Rule::in(array_keys(\App\Constants\ProfileOptions::GENDERS))],
            'date_of_birth' => ['sometimes', 'required', 'date', 'before_or_equal:-18 years'],
            'religion' => ['sometimes', 'required', 'string', \Illuminate\Validation\Rule::in(array_keys(\App\Constants\ProfileOptions::RELIGIONS))],
            ...
            'managed_by' => ['sometimes', 'required', 'string', \Illuminate\Validation\Rule::in(array_keys(\App\Constants\ProfileOptions::MANAGED_BY))],
